import { c as create_ssr_component, b as add_attribute, e as escape, d as null_to_empty, v as validate_component } from "../../chunks/ssr.js";
...
const Button = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  if ($$props.huge === void 0 && $$bindings.huge && huge !== void 0)
    $$bindings.huge(huge);
  ...
  return `<button${add_attribute("id", $$props.id, 0)} class="${[
    ...
    (big ? "big" : "") + " " + (large ? "large" : "") + " " + (huge ? "huge" : "") + " " + (inline ? "inline" : "") + " " + (borderless ? "borderless" : "")
  ].join(" ").trim()}"${add_attribute("style", $$props.style, 0)}>${slots.default ? slots.default({}) : `Button`} </button>`;
});
...
const Header = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  if ($$props.centeredContent === void 0 && $$bindings.centeredContent && centeredContent !== void 0)
          ...
          {},
          {
            default: () => {
              return `${validate_component(Container, "Container").$$render(
                ...
                {
                  default: () => {
                    return `${innerWidth < 1150 ? `<a class="logo svelte-17hh9h4" href="/">${validate_component(Image, "Image").$$render(
                      $$result,
                      {
                    ...
                    )}` : `<a class="logo svelte-17hh9h4" href="/">${validate_component(Image, "Image").$$render(
                      $$result,
                      {
                        src: "/images/logo/rahoff-scale-1.svg",
                        alt: "RaHoff"
  ...
  )} ${innerWidth < 1150 && mobileNavigationVisible ? `${validate_component(Container, "Container").$$render(
    $$result,
    {
...
const Layout = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  $$result.css.add(css);
  return `${validate_component(Header, "Header").$$render($$result, {}, {}, {})} ${validate_component(Container, "Container").$$render(
    $$result,
    {
      fullWidth: true,
      style: "margin-bottom: auto; margin-top: auto;"
