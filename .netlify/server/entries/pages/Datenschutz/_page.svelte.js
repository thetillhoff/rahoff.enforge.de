...
const Page = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  return `${$$result.head += `<!-- HEAD_svelte-arrqad_START -->${$$result.title = `<title>Datenschutz</title>`, ""}<meta name="description" content="Rahoff Datenschutz"><!-- HEAD_svelte-arrqad_END -->`, ""} ${validate_component(Container, "Container").$$render(
    $$result,
    {
      vertical: true,
      centered: true,
