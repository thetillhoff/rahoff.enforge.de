...
function _page($$payload) {
  head($$payload, ($$payload2) => {
    $$payload2.title = `<title>Datenschutz</title>`;
    $$payload2.out.push(`<meta name="description" content="Rahoff Datenschutz"/>`);
  });
  Container($$payload, {
    vertical: true,
    centered: true,
    ...
    children: ($$payload2) => {
      $$payload2.out.push(`<h1>Datenschutz</h1> <span>Beim Aufrufen dieser Webseite werden automatisch folgende Daten beim Hosting-Provider
		gespeichert: <ul><li>Ihre IP-Adresse</li> <li>Datum und Uhrzeit Ihres Zugriffs</li> <li>Name und URL der abgerufenen Datei</li> <li>verwendeter Browser &amp; ggf. das verwendete Betriebssystem</li></ul> Die genannten Daten werden zu folgenden Zwecken verarbeitet: <ul><li>Gewährleistung eines reibungslosen Verbindungsaufbaus der Webseite</li> <li>Gewährleistung einer komfortablen Nutzung der Webseite</li> <li>Auswertung der Systemsicherheit und -stabilität</li> <li>weitere administrative Zwecke</li></ul> Die Rechtsgrundlage für die Datenverarbeitung ist Art 6. Abs. 1 S. 1 lit. f DSGVO. In keinem Fall
		werden die erhobenen Daten zu dem Zweck erhoben, Rückschlüsse auf Ihre Person zu ziehen.</span> <h2>Google Analytics</h2> <span>Diese Website benutzt Google Analytics, einen Webanalysedienst der Google Inc. (“Google”).
		...
		beschriebenen Art und Weise und zu dem zuvor benannten Zweck einverstanden.</span>`);
    },
    $$slots: { default: true }
  });
}
