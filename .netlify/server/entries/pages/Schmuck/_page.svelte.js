...
const Page = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  return `${$$result.head += `<!-- HEAD_svelte-fgh0fl_START -->${$$result.title = `<title>Schmuck</title>`, ""}<meta name="description" content="Rahoff Schmuck"><!-- HEAD_svelte-fgh0fl_END -->`, ""} ${validate_component(Container, "Container").$$render(
    $$result,
    {
      vertical: true,
      fullWidth: true,
    ...
    {
      default: () => {
        return `<h1 data-svelte-h="svelte-12n554c">Schmuck</h1> ${validate_component(ElementGrid, "ElementGrid").$$render($$result, {}, {}, {
          default: () => {
