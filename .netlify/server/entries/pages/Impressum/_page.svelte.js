...
const Page = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  return `${$$result.head += `<!-- HEAD_svelte-j4zlqd_START -->${$$result.title = `<title>Impressum</title>`, ""}<meta name="description" content="Rahoff Impressum"><!-- HEAD_svelte-j4zlqd_END -->`, ""} ${validate_component(Container, "Container").$$render(
    $$result,
    {
      vertical: true,
      centered: true,
