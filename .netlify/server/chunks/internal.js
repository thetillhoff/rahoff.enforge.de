...
const options = {
  ...
  templates: {
    app: ({ head, body, assets, nonce, env }) => '<!doctype html>\n<html lang="de">\n	<head>\n		<meta charset="utf-8" />\n		<link rel="icon" href="' + assets + `/favicon.ico" />
		...
		<!-- <link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/normalize/8.0.1/normalize.min.css" on:error="this.onerror=null;this.href='/normalize.min.css'"> -->
