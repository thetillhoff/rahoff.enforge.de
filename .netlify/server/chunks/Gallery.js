import { c as create_ssr_component, v as validate_component, b as add_attribute, h as each } from "./ssr.js";
...
const Gallery = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  let galleryImage;
  if ($$props.mainImageSource === void 0 && $$bindings.mainImageSource && mainImageSource !== void 0)
    $$bindings.mainImageSource(mainImageSource);
  if ($$props.galleryImageSources === void 0 && $$bindings.galleryImageSources && galleryImageSources !== void 0)
  ...
  return `${validate_component(Container, "Container").$$render(
    ...
    {
      default: () => {
        return `<div class="galleryMain svelte-y9woxz"><img${add_attribute("src", mainImageSource, 0)} alt="Active entry of the gallery"${add_attribute("this", galleryImage, 0)}></div> ${validate_component(Container, "Container").$$render($$result, { class: "galleryList", spaced: true }, {}, {
          default: () => {
