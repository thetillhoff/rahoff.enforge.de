...
const Container = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  if ($$props.verticalCenteredContent === void 0 && $$bindings.verticalCenteredContent && verticalCenteredContent !== void 0)
    $$bindings.verticalCenteredContent(verticalCenteredContent);
  if ($$props.horizontalCenteredContent === void 0 && $$bindings.horizontalCenteredContent && horizontalCenteredContent !== void 0)
  ...
  return `<div${add_attribute("id", $$props.id, 0)} class="${[
    ...
    (textContainer ? "textContainer" : "") + " " + (fullWidth ? "fullWidth" : "") + " " + (centered ? "centered" : "") + " " + (vertical ? "vertical" : "") + " " + (spaced ? "spaced" : "") + " " + (verticalCenteredContent ? "verticalCenteredContent" : "") + " " + (horizontalCenteredContent ? "horizontalCenteredContent" : "") + " " + (hidden ? "hidden" : "")
  ].join(" ").trim()}"${add_attribute("style", $$props.style, 0)}>${slots.default ? slots.default({}) : `
