import * as universal from '../entries/pages/Schmuck/Ringe/_page.ts.js';

export const index = 10;
let component_cache;
export const component = async () =>
	(component_cache ??= (await import('../entries/pages/Schmuck/Ringe/_page.svelte.js')).default);
export { universal };
export const universal_id = 'src/routes/Schmuck/Ringe/+page.ts';
export const imports = [
	'_app/immutable/nodes/10.6b9b85c4.js',
	...
	'_app/immutable/chunks/ElementPanel.3dfc7e01.js',
...
export const stylesheets = [
	...
	'_app/immutable/assets/ElementPanel.753e12d7.css',
