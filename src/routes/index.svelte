...
<Page centeredContent>
  <Container vertical centered textContainer verticalCenteredContent style="max-width: 50rem;">
    ...
    <p>
      Genie, Milliardär, Playboy, Philanthrop - halt stop, das war <a href="https://de.wikipedia.org/wiki/Iron_Man_(Film)">💥 Tony Stark</a>.
      <br/><br/>
      ...
      <br/><br/>
      Hier findest Du Bilder und Beschreibungen meiner Werke - wenn Dir etwas besonders gut gefällt oder Du mehr wissen möchtest, freue ich mich auf <a href="mailto:rahoff@email.de?subject=[rahoff.enforge.de] Anfrage">✉ Deine Nachricht</a>!
    </p>
  </Container>
</Page>
